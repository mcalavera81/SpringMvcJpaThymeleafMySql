...
public class JournalServiceImpl implements JournalService {
	...
	public Journal publish(Publisher publisher, Journal journal, Long categoryId) throws ServiceException {
		...
		journal.setNotified("N");

		try {
			Journal journalSaved = journalRepository.save(journal);
			subscriptionService.notifySubscribedUsers(journal);
			return journalSaved;
	...
	@Override
	public List<Journal> findNewJournals() {
		return journalRepository.findByNotified("N");
	}

	@Override
	@Transactional
	public int markNewJournalsAsNotified() {
		return journalRepository.markAsNotified();
